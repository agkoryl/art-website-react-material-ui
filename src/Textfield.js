  ...
  return (
    <div>
      <Paper className={classes.root} elevation={1}>
        ...
        conceptual ideas, or technical skill, intended to be appreciated for their beauty or
         emotional power. In their most general form these activities include the production 
         of works of art, the criticism of art, the study of the history of art, and the aesthetic
...
arts. Until the 17th century, art referred to any skill or mastery and was not
 differentiated from crafts or sciences. In modern usage after the 17th century, 
 ...
 distinguished from acquired skills in general, such as the decorative or applied arts.
        ...
        <Typography className={classes.source}>from en.wikipedia.org/wiki/Art</Typography>
      </Paper>
    </div>
  );
}
